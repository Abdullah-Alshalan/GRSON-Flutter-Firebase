...
class TakeAwayAccepetDetails extends StatefulWidget {
  @override
  _TakeAwayAccepetDetailsState createState() => _TakeAwayAccepetDetailsState();
}

class _TakeAwayAccepetDetailsState extends State<TakeAwayAccepetDetails> {
  @override
